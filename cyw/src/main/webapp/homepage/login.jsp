...
<script type="text/javascript">
	...
	function login(){
		...
		document.myForm.action = "loginService.jsp";
...
<div id="container">
	...
	<ul class="path">
			<li><a href="<%=cp%>/homepage/index.jsp">
			홈</a></li>
			<li class="current"><a href="<%=cp%>/homepage/login.jsp">
			로그인</a></li>
	</ul>
	...
	<div class="list01 mgT20">
		<ul>
			<li>아직 싸이월드 회원이 아니신가요? <a href="<%=cp%>/homepage/createUser.jsp" class="btnF flR">회원가입</a></li>
			<li>회원 아이디 또는 비밀번호를 잊으셨나요? 
			<a href="<%=cp%>/homepage/findPw.jsp" class="btnF flR">비밀번호찾기</a>
            <a href="<%=cp%>/homepage/findId.jsp" class="btnF flR">아이디 찾기</a>
            </li>
		</ul>
	</div>
