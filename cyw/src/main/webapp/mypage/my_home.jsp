			...
			<td>
				<table border="0" align="left" width="800" height="510">
					<tr>
						...
						<td height="40">
							<iframe frameborder="0" width="470" height="40" 
								src="my_top_title.jsp">
							</iframe> 
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td width="178" height="450" background="<%=cp%>/resources/images/bg_left_rect.jpg">

							<!-- 왼쪽 내용 부분 ----------------------------------------------------------- -->
							<center>
								<iframe frameborder="0" width="160" height="440" src="my_left_intro.jsp"></iframe> 
							</center>
							<!-- ---------------------------------------------------------------------------- -->
						...
						<td width="480" height="450" background="<%=cp%>/resources/images/bg_center_rect.jpg">
							...
							<center>
							<!-- 오른쪽 내용 부분 ----------------------------------------------------------- -->
							<iframe frameborder="0" width="470" height="430" src="my_r_home.jsp"></iframe> 
							<!-- ---------------------------------------------------------------------------- -->
							</center>
						</td>
