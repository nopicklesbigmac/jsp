...
<meta charset="UTF-8">
<title>★${sessionScope.username }님의 싸이월드★</title>
...
<body style="background: url(<%=cp%>/img<%=back %>) no-repeat;" id="backBg" class="backBg">
	<table border="0" align="left" valign="top" cellspacing="0"	cellpadding="0">
		<tr>
			<td> 
				<iframe src="my_home.jsp" width="1060" height="550" style="position:absolute; top: 10px; left:33px;"></iframe>
			</td>
		</tr>
	</table>
			...
			<c:if test="${dto.songOrder==1 }">
				<div id="audioPlayerDiv${index }" >
					...
					<div style="float: right;padding-right: 5px;">
						<font>
							<span id="playingTimeSpan${index }"
								 style="font-size:9pt;color: #5D5D5D;">
							</span>
						</font>
					</div>
