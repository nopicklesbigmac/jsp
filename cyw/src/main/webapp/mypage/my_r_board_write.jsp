...
<!DOCTYPE html>
<html>
<head><link rel="stylesheet" href="${resourcePath }/img${fontCss}"/><link rel="stylesheet"/>
<meta charset="UTF-8">
...
<script language="javascript">
 ...
 <form action="" name="upload" method="post" enctype="multipart/form-data">
	...
	<table align="center" border="0" bgcolor="#EBEBEB" width="420" cellpadding="1" cellspacing="1">
		...
		<tr bgcolor="#FFFFFF" height="35px">
			...
			<td style="padding-left: 5px;">
				<input type="file" id="uploadId" name="upfile" size="35" style="font-size: 9pt;"/>
			</td>
		</tr>		
	</table>
	<table align="center" border="0" cellpadding="0" cellspacing="0" width="420">
		<tr height="40px">
			<td align="right">  
				<input type="hidden" name="folderName" value="<%=board.getFolderName() %>"/>
				<input type="button" name="files_save" value="작성완료" onclick="upload_ok()" 
				style="height: 25px; width: 75px; font-size: 8pt;"/>
				<input type="button" value="취소" onclick="javascript:location.href='my_r_board_page.jsp?folderName=<%=board.getFolderName()%>&pageNum=<%=board.getNum()%>';"
				style="height: 25px; width: 75px; font-size: 8pt;"/>
			</td>
		</tr>
	</table>
