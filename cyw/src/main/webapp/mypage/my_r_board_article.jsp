...
function deleteReple(repleNum){
 ...
 <form action="" name="upload" method="post" enctype="multipart/form-data">
	...
	<table align="center" border="0" bgcolor="#FFFFFF" width="420" cellpadding="1" cellspacing="1">
		<tr bgcolor="#FFFFFF" height="30px">
			...
			<td width="360" align="right"><font style="font-size:9pt;">
				<%=dto.getCreated() %></font> <font style="color:#99aa99; font-size:9pt;">조회수</font> <font style="color: #ff5500; font-size:9pt;"><%=hitcount %></font>
			</td>
		</tr>	
	</table>
	...
	<table align="center" border="0" cellpadding="0" cellspacing="0" width="420">
		...
		<tr>
			<td align="right">  <font style="color:#99aa99; font-size:9pt;">첨부파일 :</font> <a href="javascript:location.href='my_r_download.jsp?saveFileName=<%=dto.getSaveFileName() %>&userid=<%=dto.getUserId() %>"><%=dto.getSaveFileName() %></a>
			</td>
		</tr>
		<%} %>
