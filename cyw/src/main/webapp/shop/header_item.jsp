...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#logourl").attr("href", "../product/list.jsp?type=all");		
	});
		...
		for (var i = 0; i < opts.length; i++) {
			if (opts[i].value === val) {
				$.get(
		    			...
		    			function(data) {
		    				// alert(data);
		    				location.href = "../shop/product/listdetail.jsp?num=" + data;
		    			}
		    		);
		        break;
		    }
...
<div id="gnb">
	...
	<ul class="gnb">
		<li class=""><a href="javascript:location.href='../product/list.jsp?type=배경음악';"
			class="gnbDep1">배경음악
			</a></li>
		<li class=""><a href="javascript:location.href='../product/list.jsp?type=스킨';"
			class="gnbDep1">스킨
			</a></li>
		<li class=""><a href="javascript:location.href='../product/list.jsp?type=글꼴';"
			class="gnbDep1">글꼴
			</a></li>
		<li class=""><a href="javascript:location.href='../product/list.jsp?type=미니미';"
			class="gnbDep1">미니미
			</a></li>
		<li class=""><a href="javascript:location.href='../product/list.jsp?type=스토리룸';"
			class="gnbDep1">스토리룸
			</a></li>
