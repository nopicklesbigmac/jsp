...
<%
	...
	ArrayList<CyCartDTO> lists = cyitemshopDao.cartuser(userId);
	// 총가격
	// 보유 도토리 테스트 시 * 1000
...
<%} %>
	...
	<div class="btnWrap cart" style="width:100%;margin:20px auto 0 !important;">
		...
		<!-- 01-08 현종 추가 -->
		<a href="<%=cp %>/shop/product/list.jsp" class="btnM sub2" style="min-width:100px !important;">취소</a>
	</div></div>
	</div>
	</div>
</div>
